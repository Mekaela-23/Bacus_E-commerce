  ...
  return (
    <>
      <style>{`
        ...
        .footer__btn-link { display: block; color: #666666; background: none; border: none; cursor: pointer; font-size: 14px; margin-bottom: 10px; transition: color 0.2s; font-family: 'Jost', sans-serif; padding: 0; text-align: left; }
        .footer__btn-link:hover { color: #c8a96e; }
        ...
        <div style={{
          ...
          <div>
            ...
            {["Crystal Collection", "Modern Designs", "Vintage Series", "Special Offers"].map(l => (
              <button key={l} className="footer__btn-link">{l}</button>
            ))}
          </div>
